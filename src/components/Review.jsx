...
const Review = () => {
  return (
    <div style={{padding: '40px',display: 'flex',flexWrap: 'wrap',gap: '40px',justifyContent: 'center'}}>
...
></iframe>
        ...
        <Link to="/blog" className='navlink'style={{display: 'inline-flex',alignItems: 'center',gap: '6px',padding: '10px 18px',backgroundColor: '#28a745',color: '#fff',borderRadius: '20px',fontWeight: 'bold',textDecoration: 'none',marginTop: '16px',cursor: 'pointer'}}>Blog <span>→</span></Link>
      </div>
