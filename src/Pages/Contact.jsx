        ...
        <div style={{margin: '0 20px',alignItems: 'right', justifyContent: 'right'}}>
          ...
          <div style={{ flex: '1 1 55%', minWidth: '300px', borderRadius: '10px', overflow: 'hidden' }}>
            <iframe
              ...
              width="100%"
              height="100%"
              style={{ minHeight: '350px', maxWidth: '70%', border: 0, borderRadius: '10px', marginLeft: '30%' }}
              allowFullScreen
              loading="lazy"
              referrerPolicy="no-referrer-when-downgrade"
            src="https://www.google.com/maps?q=27%20Obodoi%20Street,%20Accra,%20Ghana&output=embed"
          ></iframe>
        </div>
      </div>
    </div>
